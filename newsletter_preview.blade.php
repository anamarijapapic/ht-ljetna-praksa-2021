...
<body style="margin: 0; padding: 0; word-spacing: normal; background-color: #e20074;">
              ...
              <tr>
                ...
                @FOR($i=1; $i<$counter+1; $i+=1)
                  ...
                  <div class="col-news" style="display: inline-block; width: 100%; max-width: 270px; vertical-align: top; margin: 15px;">
                      <h3 style="margin: 0 0 25px 0; font-size: 16px; line-height: 24px;">{{$data["title_secondary-$i"]}}</h3>                          @IF($pictureNames[$i] != "")
  ...
  <button type="button" class="btn" id="send" style="width: 200px; height: 40px; display: block; margin-left: auto; margin-right: auto; margin-bottom: 30px; border: none; border-radius: 10px; background-color: #ffffff; color: #e20074; font-size: 20px; font-weight: bold;">Pošalji e-mail</button>
...
<script type="text/javascript">
  ...
  document.getElementById('send').onclick = function() {
    ...
    {!! "var mainPictureName = ". json_encode($mainPictureName) . ";\n" !!}
    {!! "var pictureNames = ". json_encode($pictureNames) . ";\n" !!}
